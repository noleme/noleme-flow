 ...
 *
 * LeadOut nodes include {@link Source}, {@link Pipe}, {@link Join} and {@link com.noleme.flow.stream.StreamAccumulator}.
 *
 * @author Pierre Lecerf (pierre@illuin.tech)
 * Created on 2021/11/05
 */
public interface LeadOut<O> extends FlowOut<O>
{
    /**
     ...
     */
    <JI, JO> Join<O, JI, JO> join(LeadOut<JI> input, BiTransformer<O, JI, JO> transformer);
